...
class APITestCase(unittest.TestCase):
    ...
    def test_bad_auth(self):
        ...
        u = User(email = 'guopeng@example.com', password = 'cat', confirmed = True, role = r)
        db.session.add(u)
        db.session.commit()

        # authenticate with bad password
        response = self.client.get(url_for('api.get_posts'),
                headers = self.get_api_headers('guopeng@example.com', 'dog'))
    ...
    def test_token_auth(self):
        ...
        response = self.client.get(url_for('api.get_token'),
                headers = self.get_api_headers('guopeng@example.com', 'cat'))
    ...
    def test_unconfirmed_account(self):
        ...
        r = Role.query.filter_by(name = 'User').first()
        self.assertIsNotNone(r)
        u = User(email = 'guopeng@example.com', password = 'cat', confirmed = False, role = r)
        db.session.add(u)
        db.session.commit()
    ...
    def test_posts(self):
        ...
        response = self.client.get(
            url, headers = self.get_api_headers('guopeng@example.com', 'cat'))
        self.assertEqual(response.status_code, 200)
        json_response = json.loads(response.data.decode('utf-8'))
    ...
    def test_users(self):
        ...
        r = Role.query.filter_by(name = 'User').first()
        self.assertIsNotNone(r)
        u1 = User(email = 'guopeng@example.com', username = 'guopeng',
        ...
        self.assertEqual(response.status_code, 200)
        json_response = json.loads(response.data.decode('utf-8'))
        self.assertEqual(json_response['username'], 'guopeng')
